...
class HomeController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        userLabel.topAnchor.constraint(equalTo: HeaderView.bottomAnchor, constant: 18).isActive = true
        ...
        emailLabel.topAnchor.constraint(equalTo: userLabel.bottomAnchor, constant: 0).isActive = true
